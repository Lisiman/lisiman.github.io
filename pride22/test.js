...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  var purple = rgb(162, 138, 241);
  var blue = rgb(82, 31, 241);

  let material = new THREE.ShaderMaterial({
    uniforms: {
      // u_bg: { type: "v3", value: rgb(162, 138, 241) },
      u_bg: { type: "v3", value: purple },

      u_bgMain: { type: "v3", value: purple },
      u_color1: { type: "v3", value: purple },
